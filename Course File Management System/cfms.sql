...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 21, 2015 at 05:58 AM
...
('SCSB', 2103, 'Bioinformatics I', 3),
('SCSB', 3032, 'Bioinformatic Project I', 2),
('SCSB', 3103, 'Bioinformatics II', 3),
('SCSB', 3133, 'Computational Biology I', 3),
('SCSB', 3203, 'Programming for Bioinformatics', 3),
('SCSB', 3213, 'Bioinformatics Database', 3),
('SCSB', 3223, 'Computational Biology II', 3),
('SCSB', 4114, 'Industrial Training Report', 4),
('SCSB', 4118, 'Industrial Training (HW)', 8),
('SCSB', 4134, 'Bioinformatics Project II', 4),
('SCSB', 4213, 'Bioinformatics Visualization', 3),
('SCSB', 4243, 'Special Topics in Bioinformatics', 3),
('SCSB', 4313, 'Bioinformatics Modelling and Simulation', 3),
('SCSD', 1513, 'Technology & Information System', 3),
('SCSD', 2523, 'Database', 3),
('SCSD', 2613, 'System Analysis and  Design', 3),
('SCSD', 2623, 'Database Programming', 3),
...
('SCSJ', 2253, 'Requirement Engineering & Software Modelling', 3),
('SCSJ', 2363, 'Software Project Management', 3),
('SCSJ', 3032, 'Software Engineering Project I', 2),
('SCSJ', 3104, 'Applications Development', 4),
('SCSJ', 3203, 'Computer Science Theory', 3),
('SCSJ', 3253, 'Programming Technique III', 3),
('SCSJ', 3303, 'Internet Programming', 3),
('SCSJ', 3323, 'Software Design & Architecture', 3),
('SCSJ', 3343, 'Software Quality Assurance', 3),
('SCSJ', 3403, 'Special Topics in Software Engineering', 3),
('SCSJ', 3553, 'Artificial Intelligence', 3),
('SCSJ', 3563, 'Computational Intelligence', 3),
('SCSJ', 3603, 'Knowledge-based Expert System', 3),
('SCSJ', 4114, 'Industrial Training Report', 4),
('SCSJ', 4118, 'Industrial Training (HW)', 8),
('SCSJ', 4134, 'Software Engineering Project II', 4),
('SCSJ', 4383, 'Software Construction', 3),
('SCSJ', 4423, 'Real-time Software Engineering', 3),
('SCSJ', 4463, 'Agent-Oriented Software Engineering', 3),
('SCSJ', 4483, 'Web Technology', 3),
('SCSR', 1013, 'Digital Logic', 3),
('SCSR', 1213, 'Network Communications', 3),
('SCSR', 2033, 'Computer Organisation & Architecture', 3),
('SCSR', 2043, 'Operating Systems', 3),
('SCSR', 2233, 'Network', 3),
('SCSR', 2242, 'Computer Networks', 3),
('SCSR', 2941, 'Computer Networks Lab', 3),
('SCSR', 3032, 'Computer Network & Security Project I', 2),
('SCSR', 3104, 'Applications Development', 4),
('SCSR', 3242, 'Inter Networking Technology', 2),
('SCSR', 3243, 'Netcentric Computing', 3),
('SCSR', 3253, 'Network programming', 3),
('SCSR', 3413, 'Computer Security', 3),
('SCSR', 3443, 'Cryptography', 3),
('SCSR', 3941, 'Inter Networking Technology Lab', 1),
('SCSR', 4114, 'Industrial Training Report', 4),
('SCSR', 4118, 'Industrial Training (HW)', 8),
('SCSR', 4273, 'Network Administration and Management', 3),
('SCSR', 4283, 'Network Analysis and Design Simulation', 3),
('SCSR', 4453, 'Network Security', 3),
('SCSR', 4473, 'Security Management', 3),
('SCSR', 4483, 'Security Programming', 3),
('SCSR', 4493, 'Computer Forensic', 3),
('SCSR', 4973, 'Computer NEtwork & Security Special Topic', 3),
('SCSV', 1113, 'Mathematics for Computer Graphics', 3),
('SCSV', 1223, 'Web Programming', 3),
('SCSV', 2013, 'Graphic Design', 3),
('SCSV', 2113, 'Human Computer Interaction', 3),
('SCSV', 2122, 'Fundamental of image Processing', 3),
('SCSV', 3032, 'Graphics and Multimedia Software Project I', 2),
('SCSV', 3104, 'Applications Development', 4),
('SCSV', 3113, 'Geometric Modelling', 3),
('SCSV', 3123, 'Real-time Computer Graphics', 3),
('SCSV', 3213, 'Fundamental of Image Processing', 3),
('SCSV', 3223, 'Multimedia Data Processing', 3),
('SCSV', 3233, 'Multimedia Networking', 3),
('SCSV', 4114, 'Industrial Training Report', 4),
('SCSV', 4118, 'Industrial Training (HW)', 8),
('SCSV', 4213, 'Computer GAmes Development', 3),
('SCSV', 4233, 'Data Visualization', 3),
('SCSV', 4263, 'Multimedia Web Programming', 3),
('SCSV', 4273, 'Introduction to Speech Recognition', 3),
('SCSV', 4283, 'Windows Programming', 3),
('UCSD', 2762, 'Fundamental of Technopreneurship', 2),
('UHAS', 1162, 'Art, Custom and Beliefs of Malaysia', 2),
('UHAS', 1172, 'Malaysia Dynamic', 2),
('UICI', 1022, 'Islamic & Aisan Civilisation (TITAS)', 2),
('UICI', 2032, 'Science, Technology & Human', 2),
('ULAB', 1112, 'Academic English Skills', 2),
('ULAB', 2122, 'Advanced Academic English Skills', 2),
('ULAB', 3162, 'English for Professional Purpose', 2),
('ULAM', 1112, 'Bahasa Melayu untuk Komunikasi', 2);
...
INSERT INTO `upload_checklist` (`checklistID`, `label`, `description`) VALUES
(1, 'Appointment Letter', 'Appointment Letter of Lecturer'),
(2, 'L1', 'L1'),
(3, 'Student List', 'Student List'),
(4, 'Slides', 'Copy of Teaching Material'),
(5, 'Course Work', 'Assignments/Tutorials/Labs Related/Others'),
(6, 'Quizes/Mid-Term', 'Quizes/Mid-Term Exams papers with answer scheme'),
(7, 'Final Exam', 'Final Exam Papers with answer scheme'),
(8, 'Course work grades', 'Course work grades'),
(9, 'Grade Report', 'Grade sheet and statistical report'),
(10, 'Attendance Report', 'Attendance list and record of consultation with problematic students'),
(11, 'E-learning', 'A snapshot of e-learning/individual website for course management'),
(12, 'Questionaire', 'Course survey questionnaires and results'),
(13, 'Others teaching materials', 'Other materials related to teaching'),
(14, 'Course coordinator report', 'Course coordinator report'),
(15, 'Course Review Report', 'Course Review Report');
...
ALTER TABLE `batch_courses`
  ADD CONSTRAINT `batch_courses_ibfk_1` FOREIGN KEY (`batchID`) REFERENCES `batch` (`batchID`),
  ADD CONSTRAINT `courses_ID` FOREIGN KEY (`courseCode`, `courseID`) REFERENCES `course` (`courseCode`, `courseID`);
