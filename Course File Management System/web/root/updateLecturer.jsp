...
<%
	...
	ResultSet rs = DB.query("SELECT * FROM user, profile, department WHERE profile.username= '"+username+"' AND profile.departmentID=department.departmentID AND user.username = profile.username");
        rs.next();
%>
