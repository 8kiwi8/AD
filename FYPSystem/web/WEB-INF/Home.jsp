  ...
  <div class="carousel-inner" role="listbox">
          ...
          for(int i=0;i<newsID.size();i++){
            if(i==0){
                %><div class="item active"><a>
                        <img style="border-radius: 5px" src="news/<%=newsTitle.get(i)%>.jpg"  alt="<%=newsTitle.get(i)%>"></a>
      <div class="carousel-caption">
        <h3><%=newsContent.get(i)%></h3>
                ...
                <div class="item">
      <img style="border-radius: 5px" src="news/<%=newsTitle.get(i)%>.jpg"  alt="<%=newsTitle.get(i)%>">
      <div class="carousel-caption">
        <h3><%=newsContent.get(i)%></h3>
      </div>
    </div><%
